...
const Navbar = () => {
    const activeLink = "flex gap-1 bg-white text-blue-900 p-1 rounded-l mr-0"
    ...
    return <>
        <aside className="text-white bg-blue-900 pl-4 pr-0">
            <Link className="flex gap-1 mb-4 ml-1 mr-4 mt-3" href="/">
